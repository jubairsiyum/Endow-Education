...
<div class="card shadow-sm border-0">
    <div class="card-header bg-primary text-white py-3">
        <h5 class="mb-0 fw-bold"><i class="fas fa-edit me-2"></i>Edit Checklist Item</h5>
    </div>
        ...
        <form action="{{ route('checklist-items.update', $checklistItem) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror"
                          ...
                          name="description"
                          rows="4"
                          placeholder="Provide detailed instructions or requirements...">{{ old('description', $checklistItem->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
