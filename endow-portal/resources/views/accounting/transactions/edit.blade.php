    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('office.accounting.transactions.update', $transaction) }}" method="POST" id="transactionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('entry_date', $transaction->entry_date->format('Y-m-d')) }}"
                                       required>
                                @error('entry_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('headline', $transaction->headline) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="currency" id="currency" class="form-select @error('currency') is-invalid @enderror" required>
                                    <option value="BDT" {{ old('currency', $transaction->currency) == 'BDT' ? 'selected' : '' }}>BDT (৳)</option>
                                    <option value="USD" {{ old('currency', $transaction->currency) == 'USD' ? 'selected' : '' }}>USD ($)</option>
                                    <option value="KRW" {{ old('currency', $transaction->currency) == 'KRW' ? 'selected' : '' }}>KRW (₩)</option>
                                </select>
                                @error('currency')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="student_name" 
                                            ...
                                            style="width: 100%;">
                                        @if(old('student_name', $transaction->student_name))
                                            <option value="{{ old('student_name', $transaction->student_name) }}" selected>{{ old('student_name', $transaction->student_name) }}</option>
                                        @endif
                                    </select>
                                    ...
                                    @enderror
                                           ...
                                           class="form-control @error('student_name') is-invalid @enderror"
                                           value="{{ old('student_name', $transaction->student_name) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="payment_method" id="payment_method" class="form-select @error('payment_method') is-invalid @enderror">
                                        ...
                                        <option value="Mobile Payment" {{ old('payment_method', $transaction->payment_method) == 'Mobile Payment' ? 'selected' : '' }}>Mobile Payment</option>
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="remarks" 
                                      ...
                                      rows="3"
                                      placeholder="Enter any additional notes or remarks">{{ old('remarks', $transaction->remarks) }}</textarea>
                            @error('remarks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
