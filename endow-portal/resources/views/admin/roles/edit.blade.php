...
@section('breadcrumb', 'Home / Admin / Roles / Edit')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="alert alert-warning border-0 mb-4">
                ...
                <strong>Protected Role:</strong> This role is protected by the system. You can view permissions but cannot modify or delete it.
            </div>
            @endif
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body-custom">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           {{ in_array($role->name, $protectedRoles) ? 'disabled' : '' }}
                                           required>
                                    @error('name')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Role Statistics</label>
                                    <div class="d-flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="fw-bold text-success">{{ $role->users->count() }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="row g-4">
                            ...
                            @php
                                ...
                                $allChecked = !empty($modulePermissionIds) && empty(array_diff($modulePermissionIds, $rolePermissionIds));
                            @endphp
                            <div class="col-md-6">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="mt-3 text-center">
                            <small class="text-muted">Showing 10 of {{ $role->users->count() }} users</small>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        document.querySelectorAll('.permission-checkbox').forEach(checkbox => {
            checkbox.addEventListener('change', function() {
                ...
                if (moduleClass) {
                    ...
                    if (moduleCheckbox && !moduleCheckbox.disabled) {
                        const modulePermissions = document.querySelectorAll(`.permission-${moduleKey}:not(:disabled)`);
